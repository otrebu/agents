...
export function ThemeToggle() {
  return (
    <button onClick={toggleTheme} class="p-2 rounded">
      {theme() === "light" ? "🌙" : "☀️"}
    </button>
  )
}
...
- [apps/docs/src/routes/__root.tsx](https://github.com/hngngn/shadcn-solid/blob/8ab6356007bd94bd745cf4e119560ef98b823d18/apps/docs/src/routes/__root.tsx) - TS - Minimal TanStack Router setup
